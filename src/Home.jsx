...
<div className="card w-full bg-base-100 shadow-xl mt-4">
  <div className=" flex flex-col  ml-5 mr-5">
    ...
    <form>
  <label className="flex items-center mb-5">
    <select className="select select-bordered w-full max-w-xs relative focus:outline-none">
...
<div className="card w-full bg-base-100 shadow-xl mt-4">
  <div className=" flex flex-col  ml-5 mr-5">
    ...
    <form>
  <label className="flex items-center mb-5">
  <Link to="/upload"><button className="btn" onClick={()=>window.my_modal_5.showModal()}>open modal</button></Link>
  <MyModal></MyModal>
  </label>
</form>
